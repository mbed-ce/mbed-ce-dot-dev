...
As such, this document seeks to establish a policy that allows LLMs to be used within the project for constructive purposes but clearly outlines what usage is not acceptable.
